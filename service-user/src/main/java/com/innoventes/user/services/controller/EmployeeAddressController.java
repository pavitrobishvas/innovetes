...
public class EmployeeAddressController extends ServiceRequestProcessor{
	...
	public String addEmp(@RequestBody String requestBody, HttpServletRequest httpServletRequest,
		...
		ResponseEntity<Map<String, String>> response = iEmployeeAddressService.saveAdd(employeeAddressDataModel);
	...
	public String addEmpAdd(@RequestBody EmployeeAddressEntity requestBody, HttpServletRequest httpServletRequest,
			HttpServletResponse httpServletResponse) throws  DataPersistenceOperationException,Exception,InvalidServiceRequestException,ResourceNotFoundException {
		LOG.info("entered job notes creation - start");
		EmployeeAddressDataModel employeeAddressDataModel = null;
		
		ResponseEntity<Map<String, String>> response = iEmployeeAddressService.saveEmAd(requestBody);
		LOG.info("successfully created  operation ");
		return JSONConverter.convertPOJOToString(response);
	...
	public String getHr(@RequestParam("id") long id,HttpServletRequest httpServletRequest,HttpServletResponse httpServletResponse) throws DataPersistenceOperationException,Exception,InvalidServiceRequestException,ResourceNotFoundException{
		...
		return JSONConverter.convertPOJOToString(iEmployeeAddressService.getEmpAdd(id));
	}
