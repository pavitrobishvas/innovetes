...
//		BeanUtils.copyProperties(userDataModel, employeeEntity);
	 ...
	 */
	@Override
	public Page<AddressEntity> getAllAdd() throws DataPersistenceOperationException, Exception,
	...
	@Override
	public ResponseEntity<AddressEntity> getAdd(long id)
			throws DataPersistenceOperationException, ResourceNotFoundException, InvalidServiceRequestException {
		// TODO Auto-generated method stub
		AddressEntity hrEntity =iAddressRepository.findById(id);
		if (hrEntity!=null) {
	...
	@Override
	public ResponseEntity<Map<String, String>> updateAdd(AddressDataModel userDataModel)
			throws DataPersistenceOperationException,ResourceNotFoundException, InvalidServiceRequestException {
		// TODO Auto-generated method stub
		Map<String,String> response = new HashMap<String, String>();
		AddressEntity hrEntity = iAddressRepository.findById(userDataModel.getId());
		if (hrEntity!=null) {
	 ...
	 */
	@Override
	public ResponseEntity<?> partialUpdate(AddressDataModel updates)
			throws DataPersistenceOperationException, ResourceNotFoundException, InvalidServiceRequestException {
		// TODO Auto-generated method stub
		Map<String,String> response = new HashMap<String, String>();
		AddressEntity addressEntity = iAddressRepository.findById(updates.getId());
		
		if (addressEntity==null) {
			throw new ResourceNotFoundException("Address not Exists!!");
		}
		
		BeanUtils.copyProperties(updates, addressEntity);
